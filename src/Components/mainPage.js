...
const MainPage = () => {
	...
	return (
		<div className="bg-gray-700 min-h-screen p-6">
			<h1 className="text-3xl font-bold text-white mb-8 relative">Welcome, {username}!</h1>
			<div className="mb-12">
				<div className="flex justify-between items-center mb-4">
					<h2 className="text-2xl text-purple-300 font-semibold">Movies</h2>
					<Link to="/movies" className="text-purple-400 hover:underline">See All</Link>
				</div>
			...
			<div className="mb-20">
				<div className="flex justify-between items-center mb-4">
					...
					<Link to="/series" className="text-purple-400 hover:underline">See All</Link>
				</div>
